...
class Model(nn.Module):
    ...
    def forward(self, src_batch, tgt_batch):
        ...
        logits, attn_history = self.decoder(tgt_batch, final_state, memory, self.encoder.src_lengths)
...
class Translator(object):
    ...
    def translate_batch(self, src_batch, raw_tgt=None):
        ...
        with torch.no_grad():
            ...
            self.wrapped_decoder(final_state, memory, self.model.encoder.src_lengths)
